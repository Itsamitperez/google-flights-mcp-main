#!/usr/bin/env python3
"""
Flight Planner Server using MCP
...
try:
    ...
    print("Please install MCP with: pip install mcp[cli]", file=sys.stderr)
    sys.exit(1)
...
async def fetch_airports_csv(url: str = CSV_URL) -> Dict[str, str]:
    ...
    try:
        ...
        print("Please install with: pip install aiohttp", file=sys.stderr)
        return {}
